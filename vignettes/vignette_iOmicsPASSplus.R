...
#  createInputParam(data.X="Combined_data.txt", within.net="Fusednetwork_hybridmethod.txt",
...
## ---- eval=F,warning=F, echo=T------------------------------------------------
#  priorProb = createPrior(PhenotypeFile2, y = "Group",outputDir = "/iOmicsPASS/inputFiles/")
#  head(priorProb)

## ---- eval=T, echo=F----------------------------------------------------------
priorProb = read.delim("../iOmicsPASS/inputFiles/PriorProb.txt",as.is=T) 
head(priorProb)
...
#  
#  iOmicsPASS.output<-iOmicsPASS.R(ff="input_param_withPrior")
#  
